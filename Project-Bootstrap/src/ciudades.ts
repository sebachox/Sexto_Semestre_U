...
function actualizarCiudades(departamentoId: string, ciudadId: string): void {
    const departamentoSelect = document.getElementById(departamentoId) as HTMLSelectElement | null;
    const ciudadSelect = document.getElementById(ciudadId) as HTMLSelectElement | null;
